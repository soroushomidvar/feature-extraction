...
% f1=[];f2=[];f3=[];f4=[];f5=[];f6=[];f7=[];
% for s=1:size(in,2)
%     if(varname(s)==categories(1))
%         f1=[f1,in(:,s)];
%     elseif (varname(s)==categories(2))
%         f2=[f2,in(:,s)];
%     elseif (varname(s)==categories(3))
%         f3=[f3,in(:,s)];
%     elseif (varname(s)==categories(4))
%         f4=[f4,in(:,s)];
%     elseif (varname(s)==categories(5))
%         f5=[f5,in(:,s)];
%     elseif (varname(s)==categories(6))
%         f6=[f6,in(:,s)];
%     elseif (varname(s)==categories(7))
%         f7=[f7,in(:,s)];
%     end
end
